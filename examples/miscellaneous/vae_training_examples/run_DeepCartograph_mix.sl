...
CONFIG_PATH=config_mix.yml                            # Configuration file - see other examples in the repository and yaml_schemas for the default values
                                                                                    # Configuration file - see example in the repository
